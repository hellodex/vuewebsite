<template>
  <div class="refer-box">
    <div class="refer-content">
      <div class="refer-logo display-flex align-items-center">
        <svg-icon name="logo" class="logo"></svg-icon>
        <span>HelloDex</span>
      </div>
      <div class="refer-title display-flex align-items-center">
        <span class="display-flex align-items-center">利润<i>80%</i> 分给所有人的</span>
        <strong>链上交易工具</strong>
      </div>
      <p class="refer-tip">立即注册，加入我们，支持链上限价单，止盈止损，一键冲金狗</p>
      <el-form
        ref="ruleFormRef"
        :model="ruleForm"
        :rules="rules"
