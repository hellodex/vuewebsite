  ...
  <div class="search-dialog">
    <div class="search-content">
      <div class="search-history-title display-flex align-items-center justify-content-sp">
        <span class="search-txt">{{ searchSwitch ? '搜索结果' : '搜索记录' }}</span>
        <div class="search-switch display-flex align-items-center">
          <span class="swith-txt">搜索记录底部</span>
          <el-switch
      ...
      <div class="search-result" v-if="searchSwitch">
        <el-table
          :data="tokenList"
          height="400px"
      ...
      <div class="display-flex align-items-center search-history-items" v-else>
        <div
      ...
      <div class="search-label display-flex align-items-center justify-content-sp">
        <span class="search-txt">{{ searchSwitch ? '搜索记录' : i18n.t('searchResult') }}</span>
      </div>
      <div class="display-flex align-items-center search-history-items" v-if="searchSwitch">
        <div
          class="display-flex align-items-center search-history-item"
          v-for="(token, index) in historyList"
          :key="index"
